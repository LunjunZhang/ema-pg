...
def create_colocated_worker_cls(class_dict: dict[str, RayClassWithInitArgs]):
    ...
    class WorkerDict(worker_cls):
        def __init__(self):
            ...
            # Inject worker_dict into each sub-worker's fused_worker_dict so they can access each other
            # This enables features like EMA updates where ref policy needs to access actor weights
            for _, worker in self.worker_dict.items():
