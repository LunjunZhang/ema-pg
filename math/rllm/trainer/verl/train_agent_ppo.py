...
class TaskRunner:
    ...
    def run(self, config, workflow_class=None, workflow_args=None, agent_class=None, env_class=None, agent_args=None, env_args=None, agent_run_func=None):
        ...
        # Use tokenizer_path if specified (useful when model.path points to a checkpoint without tokenizer files)
        tokenizer_path = config.actor_rollout_ref.model.get("tokenizer_path", None) or local_path
